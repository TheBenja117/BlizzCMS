<section class="uk-section uk-section-xsmall uk-padding-remove slider-section">
  <div class="uk-background-cover uk-height-small-slider header-section-download"></div>
</section>
            ...
            <div>
              <div uk-grid>
                ...
                <div class="uk-width-expand@m">
                  <ul id="component-tab-left" class="uk-switcher uk-card-default">
                    <li>
                        ...
                        <tbody>
                          <?php foreach ($downloads as $files) : ?>
                            <?php if ($files->category == 1) : ?>
                              <tr>
                                <td>
                                  <div style="background:url(<?= base_url('assets/images/forums/wow-icons/' . $files->image); ?>); width: 50px; height: 50px;)"></div>
                                </td>
