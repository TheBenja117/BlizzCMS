    <section class="uk-section uk-section-xsmall uk-padding-remove slider-section">
      <div class="uk-background-cover uk-height-small-slider header-section-store"></div>
    </section>
    ...
    <section class="uk-section uk-section-xsmall main-section-slider " data-uk-height-viewport="expand: true">
      <div class="uk-container">
        ...
        <div class="uk-grid uk-grid-medium" data-uk-grid>
                          ...
                          <li class="uk-parent">
                            ...
                            <ul class="uk-nav-sub uk-nav-parent-icon" uk-nav>
                              <?php foreach ($this->store_model->getChildStoreCategory($menulist->id)->result() as $menuchildlist) : ?>
                                <?php if ($menuchildlist->main == '2' && $menuchildlist->father == $menulist->id) : ?>
                                  <li class="uk-parent">
                                    <a href="#"><?= $menuchildlist->name ?></a>
                                    <ul class="uk-nav-sub">
                                      <?php foreach ($this->store_model->getChildStoreCategory($menuchildlist->id)->result() as $menuchildlist2) : ?>
                                        <li><a href="<?= base_url('store/' . $menuchildlist2->route); ?>"><?= $menuchildlist2->name ?></a></li>
                                      <?php endforeach; ?>
                                    </ul>
                                  </li>
                                <?php elseif ($menuchildlist->main == '1' && $menuchildlist->father == $menulist->id) : ?>
          ...
          <div class="uk-card-item default">
